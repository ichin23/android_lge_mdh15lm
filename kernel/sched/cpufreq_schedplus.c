...
void update_cpu_capacity_request(int cpu, bool request, int type)
{
	...
	util_buffer[cpu] = new_capacity;
#endif
	new_capacity = new_capacity * capacity_margin_dvfs
		/ SCHED_CAPACITY_SCALE;
#ifdef CONFIG_CAPACITY_MARGIN_DVFS_POLICY_GRADIENT
	if (4 <= cpu)
		new_capacity = new_capacity * policy_capacity_margin_dvfs / 10000;
#endif
	new_capacity += scr->dl;
...
#ifdef CONFIG_CAPACITY_MARGIN_DVFS_POLICY_GRADIENT
	policy_capacity_margin_dvfs = 10000;
#endif
