...
ifneq ($(SUPPORT_EXFAT_TUXERA), )
	@cp -f ./kernel-4.9/tuxera_update.sh .
ifeq ($(findstring 64,$(TARGET_ARCH)),64)
	@sh tuxera_update.sh --target target/lg.d/mt6765-q-arm64 --use-cache --latest --max-cache-entries 2 --source-dir ./kernel-4.9 --output-dir $(KERNEL_OUT) $(SUPPORT_EXFAT_TUXERA)
else
	@sh tuxera_update.sh --target target/lg.d/mt6765-q-arm32 --use-cache --latest --max-cache-entries 2 --source-dir ./kernel-4.9 --output-dir $(KERNEL_OUT) $(SUPPORT_EXFAT_TUXERA)
endif
