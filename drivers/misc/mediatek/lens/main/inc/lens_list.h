...
/*M290 camera AF*/
#ifdef CONFIG_MTK_LENS_DW9768VAF_SUPPORT
#define DW9768VAF_SetI2Cclient DW9768VAF_SetI2Cclient_Main
#define DW9768VAF_Ioctl DW9768VAF_Ioctl_Main
#define DW9768VAF_Release DW9768VAF_Release_Main
#define DW9768VAF_GetFileName DW9768VAF_GetFileName_Main
extern int DW9768VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
                 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9768VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
               unsigned long a_u4Param);
extern int DW9768VAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9768VAF_GetFileName(unsigned char *pFileName);
#endif

#ifdef CONFIG_MTK_LENS_GT9768AF_SUPPORT
...
extern int GT9769AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GT9769AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
...
#define FMA02AF_SetI2Cclient FMA02AF_SetI2Cclient_Main
#define FMA02AF_Ioctl FMA02AF_Ioctl_Main
#define FMA02AF_Release FMA02AF_Release_Main
#define FMA02AF_GetFileName FMA02AF_GetFileName_Main
extern int FMA02AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FMA02AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int FMA02AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int FMA02AF_GetFileName(unsigned char *pFileName);
//
...
//
#define VV02AF_SetI2Cclient VV02AF_SetI2Cclient_Main
#define VV02AF_Ioctl VV02AF_Ioctl_Main
#define VV02AF_Release VV02AF_Release_Main
#define VV02AF_GetFileName VV02AF_GetFileName_Main
extern int VV02AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long VV02AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int VV02AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int VV02AF_GetFileName(unsigned char *pFileName);
//
#ifdef CONFIG_MTK_LENS_DW9763AF_1C_SUPPORT
#define DW9763AF_1C_SetI2Cclient DW9763AF_1C__SetI2Cclient_Main
#define DW9763AF_1C_Ioctl DW9763AF_1C_Ioctl_Main
#define DW9763AF_1C_Release DW9763AF_1C_Release_Main
extern int DW9763AF_1C_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9763AF_1C_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9763AF_1C_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9763AF_1C_PowerDown(void);
#endif

#ifdef CONFIG_MTK_LENS_ZC535AF_SUPPORT
#define ZC535AF_SetI2Cclient ZC535AF_SetI2Cclient_Main
#define ZC535AF_Ioctl ZC535AF_Ioctl_Main
#define ZC535AF_Release ZC535AF_Release_Main
extern int ZC535AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				 int *pAF_Opened);
...
extern int ZC535AF_PowerDown(void);
#endif
