...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	char puSendCmd[2] = { (char)(a_u2Data >> 4), (char)(((a_u2Data & 0xF) << 4) + 0x5) };
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
#if 1
		char puSendCmd1[2] = { (char)(0x0E), (char)(0xC5) };
		char puSendCmd2[2] = { (char)(0xEC), (char)(0xA3) };
		char puSendCmd3[2] = { (char)(0xA1), (char)(0x0D) };
		char puSendCmd4[2] = { (char)(0xF2), (char)(0xE8) };        // update SAC MODE 20190712
		char puSendCmd5[2] = { (char)(0xDC), (char)(0x51) };
		g_pstAF_I2Cclient->addr = AF_I2C_SLAVE_ADDR;
		g_pstAF_I2Cclient->addr = g_pstAF_I2Cclient->addr >> 1;
		i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd1, 2);  /*20190710 OPEN AF tick noise sunhaiyuan */
        msleep(40);
...
{
	char puSendCmd2[2] = { (char)(0xEC), (char)(0xA3) };
	char puSendCmd3[2] = { (char)(0xA1), (char)(0x05) };
	char puSendCmd4[2] = { (char)(0xF2), (char)(0x98) };
	char puSendCmd5[2] = { (char)(0xDC), (char)(0x51) };
/*LGE_CHANGE_S, 2019-08-05, reduced vcm tick noise for DW9714, soojong.jin@lge.com*/
	printk("Start, g_u4CurrPosition : %ld\n",g_u4CurrPosition);

	if (*g_pAF_Opened == 2) {
		LOG_INF("Wait\n");
        if (g_u4CurrPosition > 380)
        {
		    s4AF_WriteReg(380);
            g_u4CurrPosition = 380;
        }
		msleep(12);
        ...
        while(g_u4CurrPosition>60)
        {
            g_u4CurrPosition = g_u4CurrPosition - 40;
	...
	printk("End\n"); /*LGE_CHANGE, 2019-08-05, reduced vcm tick noise for DW9714, soojong.jin@lge.com*/
