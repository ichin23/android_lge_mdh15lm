...
/*
 * GT9768AF voice coil motor driver
 * 20190308 MT6762 GT_ray.lei for LQ
 *
 */
...
static int s4GT9768AF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long GT9768AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9768AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9768AF_GetFileName(unsigned char *pFileName)
{
