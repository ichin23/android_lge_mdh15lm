...
enum ACDK_SENSOR_FEATURE_ENUM {
	...
	SENSOR_FEATURE_SET_REMOSAIC_MODE,  /*LGE_CHANGE, 2020-05-28, for xtc setting in HW remosaic, soojong.jin@lge.com*/
	SENSOR_FEATURE_MAX
};
...
typedef struct m290_af_t {
	kal_uint8 data[64];
/*	kal_uint16 infinity_DAC;
	kal_uint16 macro_DAC;
	kal_uint16 gravity_offset_0_90;
	kal_uint16 gravity_offset_90_180;
*/
} m290_af_t;

typedef struct m290_lsc_t {
	kal_uint8 data[1897];
} m290_lsc_t;

typedef struct m290_otg_data {
	m290_awb_t awb_5100k;
	m290_awb_t awb_3000k;
	m290_af_t  af;
	m290_lsc_t lsc_5100k;
	m290_lsc_t lsc_3000k;

	kal_uint8 lsc_3000k_flag;
	kal_uint8 lsc_5100_flag;
	kal_uint8 af_flag;
	kal_uint8 awb_3000k_flag;
...
#define M290_AWB_SIZE	2266
#define M290_AF_SIZE	64
#define M290_LSC_SIZE	1897
/*1794 1793*/
#define M290_OTP_SIZE	sizeof(m290_otg_data_t)
///////////////// M290 OTP /////////////


///////////////// TETRACELL_CAL /////////////
#define CAL_XTC_SIZE	    2266
#define CAL_SENSORXTC_SIZE	64
#define CAL_PDXTC_SIZE	    1897

typedef struct cal_xtc_t {
	MUINT8 data[CAL_XTC_SIZE];
} cal_xtc_t;

typedef struct cal_sensorxtc_t {
	MUINT8 data[CAL_SENSORXTC_SIZE];
} cal_sensorxtc_t;

typedef struct cal_pdxtc_t {
	MUINT8 data[CAL_PDXTC_SIZE];
} cal_pdxtc_t;

typedef struct tetracell_cal_data {
	cal_xtc_t xtc_1;
	cal_xtc_t xtc_2;
	cal_sensorxtc_t  sensorxtc;
	cal_pdxtc_t pdxtc_1;
	cal_pdxtc_t pdxtc_2;

	MUINT8 reserve;
} tetracell_cal_data_t;

typedef struct tetracell_cal_format_t {
	bool flag;
	MUINT16 start_addr;
	MUINT16 size;
	MUINT16 offset;
	MUINT16 check_addr;
} tetracell_cal_format_t;
...
enum CAL_FORM {
	...
	CAL_PDXTC_1,
	CAL_PDXTC_2,
	TETRACELL_CAL_FORM_MAX
};

/*1794 1793*/
#define TETRACELL_CAL_SIZE	sizeof(tetracell_cal_data_t)
///////////////// TETRACELL_CAL /////////////
