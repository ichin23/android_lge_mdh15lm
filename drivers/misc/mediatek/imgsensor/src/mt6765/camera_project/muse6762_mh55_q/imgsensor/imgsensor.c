...
char *sensor_configs_mh55 = " hi1336_mipi_raw s5k3l6txd_mipi_raw s5k3l6_mipi_raw ov13855_mipi_raw hi556_mipi_raw gc5035_mipi_raw";
int sensor_type_mh55[7] = {0, 0, 1, 1, 2, 2, -1};
...
static inline int imgsensor_check_is_alive(struct IMGSENSOR_SENSOR *psensor)
{
    ...
    sensor_idx_flag=psensor_inst->sensor_idx;
//printk("shy %s,sensor_idx_flag=%d,psensor_name=%s",__func__,sensor_idx_flag,psensor_inst->psensor_name);
...
/*LGE_CHANGE_S, 2019-03-07, skiped unnecessary sensor probing , soojong.jin@lge.com*/
	...
	sensor_configs=  sensor_configs_mh55;
/*LGE_CHANGE_E, 2019-03-07, skiped unnecessary sensor probing , soojong.jin@lge.com*/
...
/*LGE_CHANGE_S, 2019-03-07, skiped unnecessary sensor probing , soojong.jin@lge.com*/
		if(sensor_type_mh55[i] != psensor->inst.sensor_idx) {
			pr_info("[LGE] skip sensor : sensor_type_mh55 : %d, sensor_idx : %d", sensor_type_mh55[i], psensor->inst.sensor_idx);
			continue;
		}
/*LGE_CHANGE_E, 2019-03-07, skiped unnecessary sensor probing , soojong.jin@lge.com*/
