...
kal_uint16 addr_data_pair_init_hi556[] = {
	...
	0x0954, 0x0009,
	0x0956, 0x1100,
	0x0958, 0xc880,//0xcc80
	0x095a, 0x924e,//0x0000
	0x0c00, 0x1110,
	0x0c02, 0x0011,
	0x0c04, 0x0000,
	0x0c06, 0x0200,
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
              strcpy(wide_sensor_name, "hi556_go");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
