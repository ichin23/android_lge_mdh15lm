...
#include "gc2375hmacro_mipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc2375hmacro_camera_sensor"
#define LOG_1 cam_pr_debug("GC2375HMACRO, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = (GC2375HMACRO_SENSOR_ID - 0x4),
	.checksum_value = 0x44176ee9,
	.pre = {
		.pclk = 39000000,
		.linelength = 1040,
		.framelength = 1240,
...
#if GC2375HMACRO_MIRROR_FLIP_ENABLE
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375HMACRO_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375HMACRO_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375HMACRO_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375HMACRO_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375HMACRO_BLK_Select2_L);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(macro_sensor_name, "gc2375hm_image");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
