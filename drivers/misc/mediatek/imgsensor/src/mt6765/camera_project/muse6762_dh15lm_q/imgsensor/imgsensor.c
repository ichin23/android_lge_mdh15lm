...
char macro_sensor_name[20] = "(null)";
...
{
    pr_err("show_LGCameraSensorName: rear_camera_name [%s] , front_camera_name [%s] , wide_sensor_name [%s] , macro_sensor_name [%s], aux_sensor_name[%s] \n", rear_sensor_name, front_sensor_name, wide_sensor_name, macro_sensor_name, aux_sensor_name);

        return sprintf(buf, "FCam:%s^^RCam:%s^^RCam1:%s^^RCam2:%s^^RCam3:%s^^\n", front_sensor_name, rear_sensor_name, wide_sensor_name, macro_sensor_name, aux_sensor_name);
