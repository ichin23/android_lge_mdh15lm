...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.hs_video = {
		.pclk = 288000000,
		.linelength = 3800, 			//record different mode's linelength
		.framelength = 583, 		//record different mode's framelength
		.startx = 0,
		.starty = 0,
...
kal_uint16 addr_data_pair_init_hi846[] = {
	...
	0x0954, 0x0089,
	0x0956, 0x0000,
	0x0958, 0xC880,//0xCA80
	0x095A, 0x924e,//0x924e//0x9280//0x9240
	0x0F08, 0x2F04,
	0x0F30, 0x001F,
	0x0F36, 0x001F,
	0x0F04, 0x3A00,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
            ...
            strcpy(front_sensor_name, "hi846_go");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
