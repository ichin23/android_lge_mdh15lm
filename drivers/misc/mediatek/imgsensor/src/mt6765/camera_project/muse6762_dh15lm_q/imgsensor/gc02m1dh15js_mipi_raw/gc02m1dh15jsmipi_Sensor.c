...
#include "gc02m1dh15jsmipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1dh15js_camera_sensor"
#define LOG_1 LOG_INF("gc02m1dh15js, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
extern char aux_sensor_name[20];/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1DH15JS_SENSOR_ID,
	.checksum_value = 0xdb6e1e1f,
	.pre = {
		.pclk = 84000000,
		.linelength = 2192,
		.framelength = 1276,
...
static kal_uint16 gc02m1dh15js_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1DH15JS_SENSOR_GAIN_BASE)
		reg_gain = GC02M1DH15JS_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1DH15JS_SENSOR_GAIN_MAX)
		reg_gain = GC02M1DH15JS_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC02M1DH15JS_AGC_Param[GC02M1DH15JS_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0 },
		{  1536,  1 },
		{  2035,  2 },
		{  2519,  3 },
	...
	for (gain_index = GC02M1DH15JS_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1DH15JS_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1DH15JS_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * GC02M1DH15JS_SENSOR_DGAIN_BASE / GC02M1DH15JS_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF("GC02M1DH15JS_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		GC02M1DH15JS_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_gc02m1dh15js[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0x3e, 0x90,
...
kal_uint16 addr_data_pair_capture_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0x3e, 0x90,
...
kal_uint16 addr_data_pair_normal_video_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0x3e, 0x90,
...
kal_uint16 addr_data_pair_hs_video_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0x3e, 0x90,
...
kal_uint16 addr_data_pair_slim_video_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0x3e, 0x90,
...
kal_uint16 addr_data_pair_custom1_gc02m1dh15js[] = {
	0xfe, 0x00,
	0x41, 0x06,
	0x42, 0x3c,
	0x3e, 0x90,
...
static void sensor_init(void)
{
	...
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1dh15js,
		sizeof(addr_data_pair_init_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1dh15js,
		sizeof(addr_data_pair_preview_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1dh15js,
		sizeof(addr_data_pair_capture_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1dh15js,
		sizeof(addr_data_pair_normal_video_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1dh15js,
		sizeof(addr_data_pair_hs_video_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1dh15js,
		sizeof(addr_data_pair_slim_video_gc02m1dh15js) /
		sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1dh15js_table_write_cmos_sensor(
		addr_data_pair_custom1_gc02m1dh15js,
		sizeof(addr_data_pair_custom1_gc02m1dh15js) /
		sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
                                strcpy(aux_sensor_name, "gc02m1_kingcom");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
