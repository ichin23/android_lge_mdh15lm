...
pr_info("lxl_get_imgsensorid jingshen gc2375");
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(aux_sensor_name, "gc2375h_image");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
				cam_pr_debug("lxl i2c write id: 0x%x, sensor id: 0x%x\n",
...
static kal_uint32 get_info(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("lxl_jingshen gc2375h scenario_id = %d\n", scenario_id);
