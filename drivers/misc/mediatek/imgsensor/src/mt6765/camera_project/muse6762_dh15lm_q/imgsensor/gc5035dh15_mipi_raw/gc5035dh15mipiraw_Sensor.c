...
#include "gc5035dh15mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035DH15_SENSOR_ID,
...
//			moduleID = gc5035_otp_identify();
			if (*sensor_id == imgsensor_info.sensor_id) {
				gc5035_otp_identify();
                strcpy(wide_sensor_name, "gc5035_image");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
