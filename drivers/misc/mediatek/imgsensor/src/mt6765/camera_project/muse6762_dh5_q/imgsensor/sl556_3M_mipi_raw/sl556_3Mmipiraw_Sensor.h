 ...
 *
 ****************************************************************************/
#ifndef _SL556_3MMIPI_SENSOR_H
#define _SL556_3MMIPI_SENSOR_H
...
} SL556_3M_IMGSENSOR_MODE;

struct sl556_3M_imgsensor_mode_struct {
...
} sl556_3M_imgsensor_mode_struct;

/* SENSOR PRIVATE STRUCT FOR VARIABLES*/
struct sl556_3M_imgsensor_struct {
...
} sl556_3M_imgsensor_struct;

/* SENSOR PRIVATE STRUCT FOR CONSTANT*/
struct sl556_3M_imgsensor_info_struct {
	kal_uint16 sensor_id; //record sensor id defined in Kd_imgsensor.h
	kal_uint32 checksum_value; //checksum value for Camera Auto Test
	struct sl556_3M_imgsensor_mode_struct pre; //preview scenario
	struct sl556_3M_imgsensor_mode_struct cap; //capture scenario
	struct sl556_3M_imgsensor_mode_struct cap1; //capture for PIP 24fps
	struct sl556_3M_imgsensor_mode_struct cap2; //capture for PIP 15ps
	struct sl556_3M_imgsensor_mode_struct normal_video;//normal video info
	struct sl556_3M_imgsensor_mode_struct hs_video; //high speed video relative info
	struct sl556_3M_imgsensor_mode_struct slim_video; //slim video for VT
	struct sl556_3M_imgsensor_mode_struct custom1; //custom1 scenario relative info
	struct sl556_3M_imgsensor_mode_struct custom2; //custom2 scenario relative info
	struct sl556_3M_imgsensor_mode_struct custom3; //custom3 scenario relative info
	struct sl556_3M_imgsensor_mode_struct custom4; //custom4 scenario relative info
	struct sl556_3M_imgsensor_mode_struct custom5; //custom5 scenario relative info
...
} sl556_3M_imgsensor_info_struct;
