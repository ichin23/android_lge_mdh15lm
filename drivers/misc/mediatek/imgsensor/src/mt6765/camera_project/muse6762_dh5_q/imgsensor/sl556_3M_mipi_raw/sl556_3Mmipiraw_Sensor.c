...
static void sl556_3M_otp_read(void)
{
	...
	otp_format_t otp_format_data[MDH5LM_OTP_FORM_MAX] = {
		//{true, 0x0000, 100    , 0},
		{true, 0x0401, MDH5LM_AWB_SIZE    , 0},
		{true, 0x041A, MDH5LM_AWB_SIZE    , MDH5LM_AWB_SIZE},
		{true, 0x0433, MDH5LM_LSC_SIZE * 4, MDH5LM_AWB_SIZE + MDH5LM_AWB_SIZE},
		{true, 0x0E96, MDH5LM_LSC_SIZE * 4, MDH5LM_AWB_SIZE + MDH5LM_AWB_SIZE + (MDH5LM_LSC_SIZE * 4)},
	};
