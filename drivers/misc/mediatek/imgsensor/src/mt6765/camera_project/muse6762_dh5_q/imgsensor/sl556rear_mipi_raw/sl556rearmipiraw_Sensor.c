...
#include "sl556rearmipiraw_Sensor.h"

#define PFX "sl556rear_camera_sensor"
...
static struct sl556rear_imgsensor_info_struct imgsensor_info = {
	.sensor_id = SL556REAR_SENSOR_ID,
...
static struct sl556rear_imgsensor_struct imgsensor = {
...
static kal_uint16 sl556rear_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_sl556rear[] = {
...
0x006c, 0x0000,
0x005e, 0x0200,
0x000e, 0x0000,//mage_orientation [default=0x00, r/w]
0x0e0a, 0x0001,
0x004a, 0x0100,
0x004c, 0x0000,
0x004e, 0x0100,
...
{
LOG_DEBUG("[SL556REAR] init setting start\n");
#if MULTI_WRITE
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_init_sl556rear,
		sizeof(addr_data_pair_init_sl556rear) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sl556rear[] = {
//0x0a00, 0x0000, // stream off
0x0b0a, 0x8259,
0x0f30, 0x6e25,
0x0f32, 0x7167,
...
#if MULTI_WRITE
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_preview_sl556rear,
		sizeof(addr_data_pair_preview_sl556rear) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_sl556rear[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_sl556rear[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
LOG_DEBUG("[SL556REAR] capture setting start currentfps : %d\n", currefps);
#if MULTI_WRITE
	if (currefps == 300) {
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_sl556rear,
		sizeof(addr_data_pair_capture_30fps_sl556rear) /
		sizeof(kal_uint16));
	} else {
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_capture_fps_sl556rear,
		sizeof(addr_data_pair_capture_fps_sl556rear) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_sl556rear[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
#if MULTI_WRITE
sl556rear_table_write_cmos_sensor(
		addr_data_pair_normal_video_sl556rear,
		sizeof(addr_data_pair_normal_video_sl556rear) /
		sizeof(kal_uint16));
#else
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sl556rear[] = {
...
#if MULTI_WRITE
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_hs_video_sl556rear,
		sizeof(addr_data_pair_hs_video_sl556rear) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_sl556rear[] = {
    //0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
...
#if MULTI_WRITE
	sl556rear_table_write_cmos_sensor(
		addr_data_pair_slim_video_sl556rear,
		sizeof(addr_data_pair_slim_video_sl556rear) /
		sizeof(kal_uint16));
#else
			...
			do {
				*sensor_id =return_sensor_id()+1;
				if (*sensor_id == imgsensor_info.sensor_id) {				
                    strcpy(wide_sensor_name, "sl556rear_lgit");/*LGE_CHANGE, 2019-11-14, add the camera identifying logic , bk.bae@lge.com*/
...
static kal_uint32 open(void)
{
    ...
    LOG_DEBUG("[SL556REAR] open sensor\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
		spin_unlock(&imgsensor_drv_lock);
...
{
    LOG_DEBUG("[SL556REAR] close sensor\n");
	/*No Need to implement this function*/ 
	return ERROR_NONE;
}	/*	close  */
...
{
    LOG_DEBUG("[SL556REAR] preview start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_DEBUG("[SL556REAR] capture start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_DEBUG("[SL556REAR] normal_video start\n");
...
UINT32 SL556REAR_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
    printk("SL556REAR_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	SL556REAR_MIPI_RAW_SensorInit	*/
