...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6]={
	...
	{  1600, 1200,  0, 0, 1600, 1200, 1600, 1200,
	   0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // 24FPS 
};
...
//auroflicker:need to avoid 15fps and 30 fps
	if (imgsensor.autoflicker_en == KAL_TRUE) {
		...
		write_cmos_sensor(0xfd, 0x01);	//page3
		write_cmos_sensor(0xfe, 0x02);	//fresh 
		}
	} else {
	    imgsensor.frame_length = (imgsensor.frame_length  >> 1) << 1;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
		    ...
		    if (0x78 == imgsensor.i2c_write_id) {
                //hw_info_main3_otp.sensor_name = PFX;
            } else if (0x7A == imgsensor.i2c_write_id) {
                //hw_info_main3_otp.sensor_name = "ov02b_camera_sensor";
            }	
			return ERROR_NONE;
			}
