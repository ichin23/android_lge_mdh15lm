...
#include "gc2375hmmipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc2375hm_camera_sensor"
#define LOG_1 cam_pr_debug("GC2375HM, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = (GC2375HM_SENSOR_ID - 0x2),
...
#if GC2375HM_MIRROR_FLIP_ENABLE
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375HM_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375HM_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375HM_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375HM_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375HM_BLK_Select2_L);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_err("gc2375hm i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_err("gc2375hm Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 GC2375HM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
