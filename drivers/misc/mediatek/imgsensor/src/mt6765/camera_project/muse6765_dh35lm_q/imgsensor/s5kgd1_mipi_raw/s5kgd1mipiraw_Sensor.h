 ...
 *
 ****************************************************************************/
#ifndef _S5KGD1MIPI_SENSOR_H
#define _S5KGD1MIPI_SENSOR_H
#define S5KGD1_OTP_DATA_LENGTH 64//++Bug 495635,yinjie.wt,add,20191128,for 32M x-talk data read from otp
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;
     /* custom2 for 4-cell relative information */
