...
#include "gc2375hdmipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc2375hd_camera_sensor"
#define LOG_1 cam_pr_debug("GC2375HD, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = (GC2375HD_SENSOR_ID - 0x3),
...
#if GC2375HD_MIRROR_FLIP_ENABLE
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
#elif GC2375HD_FLIP_ENABLE
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,
#elif GC2375HD_MIRROR_ENABLE
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =
{
	...
	{ 1600, 1200, 0, 0, 1600, 1200, 1600,  1200, 0000, 0000, 1600,  1200, 0, 0, 1600,  1200}  // custom1(24fps) for dual camera
};
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375HD_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375HD_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375HD_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375HD_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375HD_BLK_Select2_L);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_err("gc2375hd i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_err("gc2375hd Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	mdelay(2);//Bug 522796,zhouyikuan.wt,MODIFY,2019/12/17,bring up dual cam bokeh
	return ERROR_NONE;
}
...
UINT32 GC2375HD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
