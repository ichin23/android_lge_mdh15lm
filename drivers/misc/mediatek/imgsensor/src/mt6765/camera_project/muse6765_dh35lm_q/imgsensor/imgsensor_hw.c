	...
	enum IMGSENSOR_HW_POWER_STATUS pwr_status)
{
	...
	struct IMGSENSOR_HW_POWER_SEQ *ppower_sequence = NULL; 	/*LGE_CHANGE, 2019-12-04, H/W changes for RevA, sunjae.jung@lge.com*/  
	...
	if(lge_get_board_revno() < HW_REV_A)
		ppower_sequence = sensor_power_sequence;
	else
		ppower_sequence = sensor_power_sequence_revA;
