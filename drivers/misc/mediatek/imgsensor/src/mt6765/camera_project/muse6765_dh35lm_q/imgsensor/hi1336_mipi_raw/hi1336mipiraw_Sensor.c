...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength = 3330, 			//Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,record different mode's framelength
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 280800000,   //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,(714M*4/10)
	},
	.cap = {
		.pclk = 600000000,
		.linelength = 6004,
		.framelength = 3330,//Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
		.startx = 0,
		.starty = 0,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 561600000, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,(1428M * 4 / 10 )
	},
	// need to setting
    .cap1 = {                            
		.pclk = 600000000,
	...
	.hs_video = {
		...
		.max_framerate = 1200,
		.mipi_pixel_rate = 93600000, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,( 238M*4/10)
	},
    .slim_video = {
		.pclk = 600000000,
		.linelength = 6004,
    	...
    	.mipi_data_lp2hs_settle_dc = 85,//unit , ns
    	.max_framerate = 1200,
    	.mipi_pixel_rate = 187200000, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF, ( 467M * 4 / 10 )
    },
	...
	.mclk = 26,//Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
...
kal_uint16 addr_data_pair_init_hi1336[] = {
	0x0b00, 0x0000, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
	...
	0x3250, 0xa060,
	0x325a, 0x7a37,
	0x0734, 0x5c0f, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0736, 0xd8b0,
	0x0600, 0x1190,
	0x0602, 0x0052,
	0x0604, 0x1008,
	...
	0x06b4, 0x3ff0,
	0x0618, 0x0a80,
	0x0668, 0x4303, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x06ca, 0x02cc,
	0x066e, 0x0050,
	0x0670, 0x0050,
	0x113c, 0x0001,
	...
	0x0908, 0x0003,
	0x0708, 0x2f00,
	0x027e, 0x0100,//Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
};
#endif
...
static void sensor_init(void)
{
	...
	hi1336_table_write_cmos_sensor(
		...
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b00, 0x0000); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x0734, 0x5c0f); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x0668, 0x4303); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x0214, 0x0200);
	write_cmos_sensor(0x0216, 0x0200);
	...
	write_cmos_sensor(0x0254, 0x0001); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0440, 0x000c); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0908, 0x0003); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0708, 0x2f00); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x027e, 0x0100); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
...
kal_uint16 addr_data_pair_preview_hi1336[] = {
	0x3250, 0xa470,
	0x0730, 0x6c0f, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0732, 0xe1b0,
	0x1118, 0x0004,
	0x1200, 0x011f,
	0x1204, 0x1c01,
	...
	0x0b20, 0x8200,
	0x0f00, 0x0400,
	0x1002, 0xc319, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x103e, 0x0100,
	0x1020, 0xc106,
	0x1022, 0x0617,
	0x1024, 0x0306,
	...
	0x102c, 0x1400,
	0x1010, 0x07d0,
	0x1012, 0x00ab, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1014, 0x0013, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1016, 0x0013, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x101a, 0x0013, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0404, 0x0008,
	0x0406, 0x1087,
	0x0220, 0x0008,
	0x022a, 0x0015,
	...
	0x0238, 0x3311,
	0x0246, 0x0020,
	0x020a, 0x0cf2, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x021c, 0x0008,
	0x0206, 0x05dd,
	0x020e, 0x0cf6, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0b12, 0x0838,
	0x0b14, 0x0618,
	0x0204, 0x0200,
	0x041c, 0x0048,
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0730, 0x6c0f); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0732, 0xe1b0);
	write_cmos_sensor(0x1118, 0x0004);
	...
	write_cmos_sensor(0x1002, 0xc319); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x103e, 0x0100); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x1012, 0x00ab); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1014, 0x0013); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1016, 0x0013); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x101a, 0x0013); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x0224, 0x002c);
	write_cmos_sensor(0x022e, 0x0c61);
	write_cmos_sensor(0x0f04, 0x0004);
	...
	write_cmos_sensor(0x020a, 0x0cf2); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x021c, 0x0008);
	write_cmos_sensor(0x0206, 0x05dd);
	write_cmos_sensor(0x020e, 0x0cf6); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0b12, 0x0838);
	write_cmos_sensor(0x0b14, 0x0618);
...
kal_uint16 addr_data_pair_capture_30fps_hi1336[] = {
	...
	0x102c, 0x2400,
	0x1010, 0x07d0,
	0x1012, 0x015f, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1014, 0x005b, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1016, 0x005b, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x101a, 0x005b, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0404, 0x0008,
	0x0406, 0x1087,
	0x0220, 0x0008,
	0x022a, 0x0017,
	...
	0x0238, 0x1111,
	0x0246, 0x0020,
	0x020a, 0x0cf2, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,coarse integ time
	0x021c, 0x0008,
	0x0206, 0x05dd, //line length pck
	0x020e, 0x0cf6, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF,frame length lines
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  if( currefps == 300) {
	...
	write_cmos_sensor(0x1002, 0xc319); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x103e, 0x0000); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1020, 0xc10b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1022, 0x0a31); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1024, 0x030b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1026, 0x0d0f); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1028, 0x1a0e); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x102a, 0x1311); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x102c, 0x2400); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1010, 0x07d0); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1012, 0x015f); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1014, 0x005b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1016, 0x005b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x101a, 0x005b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0404, 0x0008);
	write_cmos_sensor(0x0406, 0x1087);
	write_cmos_sensor(0x0220, 0x0008);
	...
	write_cmos_sensor(0x0246, 0x0020);
	write_cmos_sensor(0x020a, 0x0cf2); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF ,coarse integ time
	write_cmos_sensor(0x021c, 0x0008);
	write_cmos_sensor(0x0206, 0x05dd); //line length pck
	write_cmos_sensor(0x020e, 0x0cf6); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF ,frame length lines
...
kal_uint16 addr_data_pair_hs_video_hi1336[] = {
	...
	0x102a, 0x0404,
	0x102c, 0x0400,
	0x1010, 0x0300, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1012, 0x003b, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1014, 0xffe8, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1016, 0xffe8, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x101a, 0xffe8, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0404, 0x0008,
	0x0406, 0x1087,
	0x0220, 0x000c,
	0x022a, 0x0013,
	...
	0x021c, 0x0008,
	0x0206, 0x05dd,
	0x020e, 0x033d, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0b12, 0x0280,
	0x0b14, 0x01e0,
	0x0204, 0x0200,
	0x041c, 0x0048,
...
// setting ver5.0 None PD 640x480 120fps
	...
	write_cmos_sensor(0x1002, 0xc319); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x103e, 0x0500); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1020, 0xc102); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1022, 0x0209); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1024, 0x0303); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1026, 0x0305); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1028, 0x0903); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x102a, 0x0404); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x102c, 0x0400); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1010, 0x0300); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1012, 0x003b); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1014, 0xffe8); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1016, 0xffe8); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x101a, 0xffe8); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0404, 0x0008);
	write_cmos_sensor(0x0406, 0x1087);
	...
	write_cmos_sensor(0x0246, 0x0020);
	write_cmos_sensor(0x020a, 0x0339);
	write_cmos_sensor(0x021c, 0x0008);
	write_cmos_sensor(0x0206, 0x05dd);
	write_cmos_sensor(0x020e, 0x033d); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0b12, 0x0280);
	write_cmos_sensor(0x0b14, 0x01e0);
	write_cmos_sensor(0x0204, 0x0200);
	write_cmos_sensor(0x041c, 0x0048);
	write_cmos_sensor(0x041e, 0x1047);
	write_cmos_sensor(0x0b04, 0x037e);
...
kal_uint16 addr_data_pair_slim_video_hi1336[] = {
	...
	0x102c, 0x1400,
	0x1010, 0x07d0,
	0x1012, 0x0092, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1014, 0x000e, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x1016, 0x000e, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x101a, 0x000e, //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	0x0404, 0x0008,
	0x0406, 0x1087,
	0x0220, 0x0008,
	0x022a, 0x0017,
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x1002, 0xc319); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x103e, 0x0200); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1020, 0xc104); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	...
	write_cmos_sensor(0x102c, 0x1400);
	write_cmos_sensor(0x1010, 0x07d0);
	write_cmos_sensor(0x1012, 0x0092); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1014, 0x000e); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x1016, 0x000e); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x101a, 0x000e); //Bug520214, mubaoyang.wt,ADD,2020/01/17,amend mipi and mclk for RF
	write_cmos_sensor(0x0404, 0x0008);
	write_cmos_sensor(0x0406, 0x1087);
	write_cmos_sensor(0x0220, 0x0008);
	write_cmos_sensor(0x022a, 0x0017);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err("hi1336 i2c write id : 0x%x, sensor id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("hi1336 Read id fail,sensor id: 0x%x\n", *sensor_id);
