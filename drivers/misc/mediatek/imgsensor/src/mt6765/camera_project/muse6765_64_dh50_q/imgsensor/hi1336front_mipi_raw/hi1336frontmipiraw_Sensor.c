...
kal_uint16 addr_data_pair_preview_hi1336front[] = {
	...
	0x020e, 0x0d02, //0x0681, //frame length lines
...
static void hi1336front_otp_read(void)
{
	...
	otp_format_t otp_format_data[MDH50LM_OTP_FORM_MAX] = {
		{true, 0x04C2, MDH50LM_AWB_SIZE    , 0},
		{true, 0x04E1, MDH50LM_LSC_SIZE * 4, MDH50LM_AWB_SIZE},
		{true, 0x0F4A, MDH50LM_AWB_SIZE    , MDH50LM_AWB_SIZE + (MDH50LM_LSC_SIZE * 4)},
	};
