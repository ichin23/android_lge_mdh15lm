...
#include "sl556depthmipiraw_Sensor.h"

#define PFX "sl556depth_camera_sensor"
...
#define per_frame 1
extern char aux_sensor_name[20];/*LGE_CHANGE, 2020-04-06, add the camera identifying logic , bk.bae@lge.com*/

static struct sl556depth_imgsensor_info_struct imgsensor_info = {
	.sensor_id = SL556DEPTH_SENSOR_ID,
...
static struct sl556depth_imgsensor_struct imgsensor = {
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] =
{
 ...
 { 2592, 1944,  16, 252,   2560, 1440,   1280,  720,  0, 0, 1280,  720,   0, 0, 1280,  720},	// slim vide
...
static kal_uint16 sl556depth_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_sl556depth[] = {
0x0e00,	0x0102,
0x0e02,	0x0102,
0x0e0c,	0x0100,
0x2000,	0x4031,
...
{
LOG_DEBUG("[sl556depth] init setting start\n");
#if MULTI_WRITE
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_init_sl556depth,
		sizeof(addr_data_pair_init_sl556depth) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sl556depth[] = {
...
#if MULTI_WRITE
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_preview_sl556depth,
		sizeof(addr_data_pair_preview_sl556depth) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_sl556depth[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_sl556depth[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
{
LOG_DEBUG("[sl556depth] capture setting start currentfps : %d\n", currefps);
#if MULTI_WRITE
	if (currefps == 300) {
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_sl556depth,
		sizeof(addr_data_pair_capture_30fps_sl556depth) /
		sizeof(kal_uint16));
	} else {
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_capture_fps_sl556depth,
		sizeof(addr_data_pair_capture_fps_sl556depth) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_sl556depth[] = {
    0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
#if MULTI_WRITE
sl556depth_table_write_cmos_sensor(
		addr_data_pair_normal_video_sl556depth,
		sizeof(addr_data_pair_normal_video_sl556depth) /
		sizeof(kal_uint16));
#else
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sl556depth[] = {
...
#if MULTI_WRITE
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_hs_video_sl556depth,
		sizeof(addr_data_pair_hs_video_sl556depth) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_sl556depth[] = {
    //0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
...
#if MULTI_WRITE
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_slim_video_sl556depth,
		sizeof(addr_data_pair_slim_video_sl556depth) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_24fps_sl556depth[] = {
0x0b0a,	0x8252,
0x0f30,	0x6e25,
0x0f32,	0x7067,
0x004a,	0x0100,
...
{
LOG_DEBUG("[sl556depth] custom1 setting start currentfps : %d\n", currefps);
#if MULTI_WRITE
	sl556depth_table_write_cmos_sensor(
		addr_data_pair_custom1_24fps_sl556depth,
		sizeof(addr_data_pair_custom1_24fps_sl556depth) /
		sizeof(kal_uint16));
#else
...
//	write_cmos_sensor(0x0a00, 0x0000); // stream off
	{
		LOG_DEBUG("custom1_setting fps not 300\n");
		write_cmos_sensor(0x0b0a, 0x8252);
		write_cmos_sensor(0x0f30, 0x6e25);
		write_cmos_sensor(0x0f32, 0x7067);
		write_cmos_sensor(0x004a, 0x0100);
...
{    
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			spin_unlock(&imgsensor_drv_lock);
			do {
				*sensor_id = return_sensor_id() +3;  // add 3 to sensor id to use sl556 as a depth cam
				if (*sensor_id == (imgsensor_info.sensor_id)) {				
					LOG_DEBUG("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
					strcpy(aux_sensor_name, "sl556depth_lgit");/*LGE_CHANGE, 2020-04-06, add the camera identifying logic , bk.bae@lge.com*/
					return ERROR_NONE;
				}	
...
//		"capture 2592*1944@30fps,880Mbps/lane\n");
    LOG_DEBUG("[sl556depth] open sensor\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
		spin_unlock(&imgsensor_drv_lock);
...
{
    LOG_DEBUG("[sl556depth] close sensor\n");
	/*No Need to implement this function*/
	return ERROR_NONE;
}	/*	close  */
...
{
    LOG_DEBUG("[sl556depth] preview start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_DEBUG("[sl556depth] capture start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_DEBUG("[sl556depth] normal_video start\n");
...
static kal_uint32 custom1(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    LOG_DEBUG("[sl556depth] custom1 start\n");
	spin_lock(&imgsensor_drv_lock);
	...
	else //PIP custom1: 24fps for less than 13M, 20fps for 16M,15fps for 20M
    {  
		imgsensor.pclk = imgsensor_info.custom1.pclk;
		imgsensor.line_length = imgsensor_info.custom1.linelength;
		imgsensor.frame_length = imgsensor_info.custom1.framelength;  
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    switch (feature_id) {
		case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 36000000;
		break;
...
UINT32 SL556DEPTH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    printk("sl556depth_MIPI_RAW_SensorInit\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	sl556depth_MIPI_RAW_SensorInit	*/
