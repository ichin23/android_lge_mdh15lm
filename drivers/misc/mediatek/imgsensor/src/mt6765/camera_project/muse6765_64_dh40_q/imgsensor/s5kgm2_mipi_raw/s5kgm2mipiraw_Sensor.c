...
static struct imgsensor_info_struct imgsensor_info = {
...
#if 1 //soojong test - change to max fps(10fps)
	.custom2 = {//add 48M remosaic setting
		.pclk = 640000000,
		.linelength  = 10240,
		.framelength = 6115,
		.startx= 0,
	 ...
	 */
	.i2c_addr_table = {0x7a, 0xff},//see moudle spec
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
 ...
 { 8000, 6000,  160,  840,   7680, 4320, 1920, 1080,   0,   0, 1920, 1080,   0, 0, 1920, 1080},     	/* high speed video */
 { 8000, 6000,  160,  840,   7680, 4320, 1280,  720,   0,   0, 1280,  720,   0, 0, 1280, 720},        	/* slim video */
#if STEREO_CUSTOM1_30FPS
...
#endif
 { 8000, 6000,    0,    0, 8000, 6000, 8000, 6000,   0, 0, 8000, 6000,   0, 0, 8000, 6000},  /* custom2 48M remosaic */
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
	LGE_DEBUG("streaming_control() enable = %d\n", enable);
		write_cmos_sensor(0x0100, 0x0100);
	} else {
	LGE_DEBUG("streaming_control() streamoff enable = %d\n", enable);
...
static kal_uint16 addr_data_pair_slim_gm2[] = {
	0x6214, 0xF9F3, //slim mode 1280x720 120fps
	0x0344, 0x00A0,
	0x0346, 0x0348,
	0x0348, 0x1E9F,
	0x034A, 0x1427,
...
/*M290 OTP bring up*/
extern kal_uint16 m290_otp_read(otp_format_t *p, u16 i2c_addr, enum OTP_FORM otp_form, UINT8* data_c);
extern m290_otg_data_t m290_otp_data[2];
#define HI846_I2C_ADDR		0xA4
#define FOUR_CELL_SIZE      8390 // 0x20c6
static void hi846_otp_read(void)
{
	int i;
	UINT8 *data = (UINT8*)&m290_otp_data[0];
	otp_format_t otp_format_data[M290_OTP_FORM_MAX] = {
		/*
		bool flag;
		UINT16 start_addr;
		UINT16 size;
		UINT16 offset;
		*/
		{true,  0x1704, M290_AWB_SIZE, 2}, // XTC-1 0x1704-0x1FDD
		{true,  0x1FDE, M290_AWB_SIZE, 2 + M290_AWB_SIZE}, // XTC-2 0x1FDE-0x28B7
		{true,  0x28BB, M290_AF_SIZE,  2 + M290_AWB_SIZE + M290_AWB_SIZE}, // SensorXTC 0x28BB-0x28FA
		{true,  0x28FE, M290_LSC_SIZE, 2 + M290_AWB_SIZE + M290_AWB_SIZE + M290_AF_SIZE}, // PDXTC-1 0x28FE-0x3066
		{true,  0x3067, M290_LSC_SIZE, 2 + M290_AWB_SIZE + M290_AWB_SIZE + M290_AF_SIZE + M290_LSC_SIZE} // PDXTC-2 0x3067-0x37CF
	};
	...
	*(data + 1) = ((FOUR_CELL_SIZE >> 8) & 0xff);/*High*/
	...
	printk("%s", __func__);
	for (i = 0; i < M290_OTP_FORM_MAX; i++)
		if (otp_format_data[i].flag)
			m290_otp_read(&otp_format_data[i], HI846_I2C_ADDR, i, data);

	printk("hi846_otp_read JJJason lsc_3000k_flag(%d) lsc_5100_flag(%d) af_flag(%d) awb_3000k_flag(%d) awb_5100K_flag(%d)",
			m290_otp_data[0].lsc_3000k_flag, m290_otp_data[0].lsc_5100_flag, m290_otp_data[0].af_flag,
			m290_otp_data[0].awb_3000k_flag, m290_otp_data[0].awb_5100K_flag);
}

static void custom1_setting(void)
{
#if STEREO_CUSTOM1_30FPS
	LGE_DEBUG("custom1_setting() 12 M*30 fps E!\n");
#else
	LGE_DEBUG("custom1_setting() 12 M*24 fps E!\n");
#endif
...
{
	LGE_DEBUG("custom2_setting() 40 M*5 fps E!\n");
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			if (sensor_id == imgsensor_info.sensor_id) {
				LGE_DEBUG("open():i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
				break;
			}

			LGE_DEBUG("open():Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id);
			retry--;
		} while (retry > 0);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	LGE_DEBUG("capture():imgsensor_info.cap.max_framerate = %d\n", imgsensor_info.cap.max_framerate);
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	LGE_DEBUG("get_info():sensor_info->SensorHsyncPolarity = %d\n", sensor_info->SensorHsyncPolarity);
	sensor_info->SensorVsyncPolarity = SENSOR_CLOCK_POLARITY_LOW;
	LGE_DEBUG("get_info():sensor_info->SensorVsyncPolarity = %d\n", sensor_info->SensorVsyncPolarity);
	...
	LOG_INF("get_info():MSDK_SCENARIO_ID_CUSTOM2 scenario_id= %d\n", scenario_id);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case MSDK_SCENARIO_ID_CUSTOM1:
        ...
        break;
	case MSDK_SCENARIO_ID_CUSTOM2:
		LOG_INF("control():MSDK_SCENARIO_ID_CUSTOM2 scenario_id= %d\n", scenario_id);
...
static kal_uint32 set_video_mode(UINT16 framerate)
{
	...
	LGE_DEBUG("set_video_mode():framerate = %d\n", framerate);
	...
	enum MSDK_SCENARIO_ID_ENUM scenario_id,	MUINT32 framerate)
{
	...
	case MSDK_SCENARIO_ID_CUSTOM1:
		...
		break;
	case MSDK_SCENARIO_ID_CUSTOM2:
		LOG_INF("set_max_framerate_by_scenario():MSDK_SCENARIO_ID_CUSTOM2 scenario_id= %d\n", scenario_id);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
  ...
  case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
         *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 4000000; //This value needs to be filled in based on the actual test value!
    break; //for ITS sensor fusion
