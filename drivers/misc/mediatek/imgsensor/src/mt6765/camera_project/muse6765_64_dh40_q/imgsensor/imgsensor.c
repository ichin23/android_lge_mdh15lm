...
// LGE_CHANGE_S, Fix for Black Screen Issue (ISP timeout Error) - ALPS05397682, ranjith.k@lge.com, 23rd Oct 2020
/*prevent imgsensor race condition in vulunerbility test*/
struct mutex imgsensor_mutex;
// LGE_CHANGE_E, Fix for Black Screen Issue (ISP timeout Error) - ALPS05397682, ranjith.k@lge.com, 23rd Oct 2020
