...
/*HI*/
UINT32 HI846BACK_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
/*GC*/
UINT32 GC8034BACKMIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC5025_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);// Murphy Add for 1697
UINT32 GC8034_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);// Murphy Add for 1697
