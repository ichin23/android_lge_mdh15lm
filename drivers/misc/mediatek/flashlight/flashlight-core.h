...
/* sysfs - torch */
#define FLASHLIGHT_TORCH_ARG_NUM   5
#define FLASHLIGHT_TORCH_ARG_TYPE  0
#define FLASHLIGHT_TORCH_ARG_CT    1
#define FLASHLIGHT_TORCH_ARG_PART  2
#define FLASHLIGHT_TORCH_ARG_LEVEL 3
#define FLASHLIGHT_TORCH_ARG_FLAG  4
#define FLASHLIGHT_TORCH_ARG_LEVEL_MAX 6
#define FLASHLIGHT_TORCH_ARG_FLAG_OFF  0
#define FLASHLIGHT_TORCH_ARG_FLAG_ON   1
struct flashlight_torch_arg {
	int type;
	int ct;
	int part;
	int channel;
