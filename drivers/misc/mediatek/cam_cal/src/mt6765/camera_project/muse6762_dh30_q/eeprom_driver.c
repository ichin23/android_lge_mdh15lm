...
extern unsigned char s5k3l6_otp_data[S5K3L6_OTP_SIZE];
//AWB 51K
#define S5K3L6_AWB_51K_INFO_START 0x0a
#define S5K3L6_AWB_51K_DATA_SIZE 0x10
extern unsigned char s5k3l6_awb_51k_data_valid;
//AWB 30K
#define S5K3L6_AWB_30K_INFO_START 0x1c
#define S5K3L6_AWB_30K_DATA_SIZE 0x10
extern unsigned char s5k3l6_awb_30k_data_valid;
//AF 
#define S5K3L6_AF_INFO_START 0x2e
#define S5K3L6_AF_DATA_SIZE 0x04
extern unsigned char s5k3l6_af_data_valid;
//LSC 51K
#define S5K3L6_LSC_51K_INFO_START 0x35
#define S5K3L6_LSC_51K_DATA_SIZE 1868
extern unsigned char s5k3l6_lsc_51k_data_valid;
//LSC 30K
#define S5K3L6_LSC_40K_INFO_START 0x783
#define S5K3L6_LSC_40K_DATA_SIZE 1868
extern unsigned char s5k3l6_lsc_40k_data_valid;
#define S5K3L6_LSC_DATA_SIZE 1868
#define S5K3L6_AWB_DATA_SIZE 16
//PDAF
#define S5K3L6_PDAF_INFO_START 0xed1
#define S5K3L6_PDAF_DATA_SIZE 1414
extern unsigned char s5k3l6_pdaf_data_valid;
#endif

#define HI1336_OTP  1

#if HI1336_OTP
#define HI1336_OTP_SIZE 0x0eca + 1
extern unsigned char hi1336_otp_data[HI1336_OTP_SIZE];
//AWB 51K
#define AWB_51K_INFO_START 0x0a
#define AWB_51K_DATA_SIZE 0x10
extern unsigned char hi1336_awb_51k_data_valid;
//AWB 30K
#define AWB_30K_INFO_START 0x1c
#define AWB_30K_DATA_SIZE 0x10
extern unsigned char hi1336_awb_30k_data_valid;
//LSC 51K
#define LSC_51K_INFO_START 0x2e
#define LSC_51K_DATA_SIZE 1868
extern unsigned char hi1336_lsc_51k_data_valid;
//LSC 30K
#define LSC_40K_INFO_START 0x77c
#define LSC_40K_DATA_SIZE 1868
extern unsigned char hi1336_lsc_40k_data_valid;
...
#if HI556_OTP
#define HI556_OTP_SIZE 0x0eca + 1
extern unsigned char hi556_otp_data[HI556_OTP_SIZE];
//AWB 51K
#define HI556_AWB_51K_INFO_START 0x0a
#define HI556_AWB_51K_DATA_SIZE 0x10
extern unsigned char hi556_awb_51k_data_valid;
//AWB 30K
#define HI556_AWB_30K_INFO_START 0x1c
#define HI556_AWB_30K_DATA_SIZE 0x10
extern unsigned char hi556_awb_30k_data_valid;
//LSC 51K
#define HI556_LSC_51K_INFO_START 0x2e
#define HI556_LSC_51K_DATA_SIZE 1868
extern unsigned char hi556_lsc_51k_data_valid;
//LSC 30K
#define HI556_LSC_40K_INFO_START 0x77c
#define HI556_LSC_40K_DATA_SIZE 1868
extern unsigned char hi556_lsc_40k_data_valid;
...
#if GC5035_OTP
#define GC5035_OTP_SIZE 0x0eca + 1
extern unsigned char gc5035_otp_data[HI556_OTP_SIZE];
//AWB 51K
#define GC5035_AWB_51K_INFO_START 0x0a
#define GC5035_AWB_51K_DATA_SIZE 0x10
extern unsigned char gc5035_awb_51k_data_valid;
//AWB 30K
#define GC5035_AWB_30K_INFO_START 0x1c
#define GC5035_AWB_30K_DATA_SIZE 0x10
extern unsigned char gc5035_awb_30k_data_valid;
//LSC 51K
#define GC5035_LSC_51K_INFO_START 0x2e
#define GC5035_LSC_51K_DATA_SIZE 1868
extern unsigned char gc5035_lsc_51k_data_valid;
//LSC 30K
#define GC5035_LSC_40K_INFO_START 0x77c
#define GC5035_LSC_40K_DATA_SIZE 1868
extern unsigned char gc5035_lsc_40k_data_valid;
#define GC5035_LSC_DATA_SIZE 1868
#define GC5035_AWB_DATA_SIZE 16
#endif
...
#endif
{
	...
	case CAM_CALIOC_G_READ:
...
#if S5K3L6_OTP
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x1 && ptempbuf->u4Offset == 0x1){//S5K3L6 MID data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *)&s5k3l6_otp_data[1], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
		...
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == S5K3L6_LSC_51K_INFO_START){//S5K3L6 LSC 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_LSC_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		  }
			i4RetValue = LSC_DATA_SIZE;
			kfree(pBuff);
			kfree(pu1Params);
			return i4RetValue;
		}
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == S5K3L6_LSC_40K_INFO_START){//S5K3L6 LSC 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_LSC_40K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == S5K3L6_AWB_51K_INFO_START){//S5K3L6 AWB 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_AWB_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		  }
			i4RetValue = AWB_DATA_SIZE;
			kfree(pBuff);
			kfree(pu1Params);
			return i4RetValue;
		}
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == S5K3L6_AWB_30K_INFO_START){//S5K3L6 AWB 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_AWB_30K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 0x04  && ptempbuf->u4Offset == S5K3L6_AF_INFO_START){//S5K3L6 AF data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_AF_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x3c06 && ptempbuf->u4Length == 1414  && ptempbuf->u4Offset == S5K3L6_PDAF_INFO_START){//S5K3L6 PDAF data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &s5k3l6_otp_data[S5K3L6_PDAF_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
...
#if HI1336_OTP
		if (ptempbuf->sensorID == 0x1336 && ptempbuf->u4Length == 0x1 && ptempbuf->u4Offset == 0x1){//HI1336 MID data
			hi1336_otp_data[1] = 0x14;//Modify as 0x14, different from Main cam
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *)&hi1336_otp_data[1], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x1336 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == LSC_51K_INFO_START){//HI1336 LSC 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi1336_otp_data[LSC_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x1336 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == LSC_40K_INFO_START){//HI1336 LSC 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi1336_otp_data[LSC_40K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x1336 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == AWB_51K_INFO_START){//HI1336 AWB 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi1336_otp_data[AWB_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x1336 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == AWB_30K_INFO_START){//HI1336 AWB 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi1336_otp_data[AWB_30K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
...
#if HI556_OTP
		if (ptempbuf->sensorID == 0x0556 && ptempbuf->u4Length == 0x1 && ptempbuf->u4Offset == 0x1){//HI556 MID data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *)&hi556_otp_data[1], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x0556 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == HI556_LSC_51K_INFO_START){//HI556 LSC 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi556_otp_data[HI556_LSC_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x0556 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == HI556_LSC_40K_INFO_START){//HI556 LSC 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi556_otp_data[HI556_LSC_40K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x0556 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == HI556_AWB_51K_INFO_START){//HI556 AWB 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi556_otp_data[HI556_AWB_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x0556 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == HI556_AWB_30K_INFO_START){//HI556 AWB 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &hi556_otp_data[HI556_AWB_30K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
...
#if GC5035_OTP
		if (ptempbuf->sensorID == 0x5035 && ptempbuf->u4Length == 0x1 && ptempbuf->u4Offset == 0x1){//gc5035 MID data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *)&gc5035_otp_data[1], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x5035 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == GC5035_LSC_51K_INFO_START){//gc5035 LSC 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &gc5035_otp_data[HI556_LSC_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x5035 && ptempbuf->u4Length == 0x74C && ptempbuf->u4Offset == GC5035_LSC_40K_INFO_START){//gc5035 LSC 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &gc5035_otp_data[HI556_LSC_40K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x5035 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == GC5035_AWB_51K_INFO_START){//gc5035 AWB 51K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &gc5035_otp_data[GC5035_AWB_51K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
		...
		if (ptempbuf->sensorID == 0x5035 && ptempbuf->u4Length == 0x10  && ptempbuf->u4Offset == GC5035_AWB_30K_INFO_START){//gc5035 AWB 30K data
			if (copy_to_user((u8 __user *) ptempbuf->pu1Params , (u8 *) &gc5035_otp_data[GC5035_AWB_30K_INFO_START], ptempbuf->u4Length)) {
				kfree(pBuff);
				kfree(pu1Params);
				pr_debug("ioctl copy to user failed\n");
				return -EFAULT;
