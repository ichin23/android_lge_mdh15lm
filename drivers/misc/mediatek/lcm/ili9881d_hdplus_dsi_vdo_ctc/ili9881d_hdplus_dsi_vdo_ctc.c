...
#if defined(CONFIG_LGE_NO_PANEL_POWER_IN_MFTS)
...
static struct LCM_setting_table_V3 lcm_Disp_tearing_effect_line_On[] = {
    {0x05, 0x35, 1, {0x00}},
};
...
static struct LCM_setting_table_V3 lcm_EXTC_cmd_Set_en_reg[] = {
    {0x39, 0xFF, 3, {0x98,0x81,0x00}},
};

static void init_lcm_registers_sleep_in(void)
{
    //dsi_set_cmdq_V3(lcm_EXTC_cmd_Set_en_reg, sizeof(lcm_EXTC_cmd_Set_en_reg) / sizeof(struct LCM_setting_table_V3), 1);
...
static void init_lcm_registers_sleep_out(void)
{
	...
	dsi_set_cmdq_V3(lcm_Disp_tearing_effect_line_On,sizeof(lcm_Disp_tearing_effect_line_On) / sizeof(struct LCM_setting_table_V3), 1);
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_sync_active = 33;
    ...
    params->dsi.PLL_CLOCK = 288; // mipi data rate : 576Mbps
...
static void lcm_resume(void)
{
    ...
    if (lge_get_mfts_mode() == 1) {
        touch_notifier_call_chain(LCD_EVENT_LCD_VDDIO_ON, NULL);
        MDELAY(5);
    }
#endif
...
/* --------------------------------------------------------------------------- */
struct LCM_DRIVER ili9881d_hdplus_dsi_vdo_ctc_lcm_drv = {
    .name = "CTC-ILI9881D",
