...
static struct LCM_setting_table_V3 lcm_initial_setting_CE_Digital_gamma_1[] = {
    {0x15, 0x55, 1, {0x80}},
};

static struct LCM_setting_table_V3 lcm_initial_setting_CE_Digital_gamma_2[] = {
    {0x15, 0xE0, 1, {0x03}},
    {0x15, 0x01, 1, {0x01}},
    {0x15, 0x02, 1, {0x03}},
    {0x15, 0x04, 1, {0x32}},
...
static void init_lcm_registers_sleep_out(void)
{
    ...
    dsi_set_cmdq_V3(lcm_initial_setting_CE_Digital_gamma_1, sizeof(lcm_initial_setting_CE_Digital_gamma_1) / sizeof(struct LCM_setting_table_V3), 1);
    MDELAY(5);

    dsi_set_cmdq_V3(lcm_initial_setting_CE_Digital_gamma_2, sizeof(lcm_initial_setting_CE_Digital_gamma_2) / sizeof(struct LCM_setting_table_V3), 1);
    dsi_set_cmdq_V3(lcm_initial_disp_on, sizeof(lcm_initial_disp_on) / sizeof(struct LCM_setting_table_V3), 1);
    MDELAY(5);

    dsi_set_cmdq_V3(lcm_initial_open_te, sizeof(lcm_initial_open_te) / sizeof(struct LCM_setting_table_V3), 1);
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.PLL_CLOCK = 280; // mipi data rate : 560 Mbps
