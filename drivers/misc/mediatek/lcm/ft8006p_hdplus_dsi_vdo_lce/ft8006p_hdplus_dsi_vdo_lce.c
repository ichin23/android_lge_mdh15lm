...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_frontporch = 175;
    params->dsi.vertical_active_line = FRAME_HEIGHT;

    params->dsi.horizontal_sync_active = 14;
    params->dsi.horizontal_backporch = 77;
    params->dsi.horizontal_frontporch = 77;
...
/* --------------------------------------------------------------------------- */
struct LCM_DRIVER ft8006p_hdplus_dsi_vdo_lce_drv = {
    .name = "LCE-FT8006P",
