...
/* LGE warning : If you want to add the item(ccci runtime feature),
   you should modify both Modem(ccci_if.h, ccci_hs.c) and Kernel(ccci_modem.h). */
//PCAS_ONE_BIARY - S
	MISC_INFO_SIMNUM = 44,
	MISC_INFO_HWGPIO = 45,
	MISC_INFO_NTCODE = 46,
	MISC_INFO_2NTCODE = 47,
	MISC_INFO_LASTNTCODE = 48,
	MISC_INFO_2LASTNTCODE = 49,
	MISC_INFO_GID = 50,
	MISC_INFO_2GID = 51,
	MISC_INFO_LASTGID = 52,
	MISC_INFO_2LASTGID = 53,
	MISC_INFO_HWREV = 54,
//PCAS_ONE_BIARY - E
