	...
	struct md_query_ap_feature *ap_side_md_feature)
{
	...
	ap_side_md_feature->feature_set[MISC_INFO_CUSTOMER_VAL].support_mask
		= CCCI_FEATURE_NOT_SUPPORT;
#endif
	ap_side_md_feature->feature_set[MISC_INFO_NTCODE].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_SIMNUM].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_2NTCODE].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_HWGPIO].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_LASTNTCODE].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_2LASTNTCODE].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_GID].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_2GID].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_LASTGID].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_2LASTGID].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	ap_side_md_feature->feature_set[MISC_INFO_HWREV].support_mask = CCCI_FEATURE_OPTIONAL_SUPPORT;
	...
	ap_side_md_feature->feature_set[SECURITY_SHARE_MEMORY].support_mask =
		CCCI_FEATURE_MUST_SUPPORT;
}
