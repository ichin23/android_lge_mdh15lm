...
#define LAF_RX_BUFFER_INIT_SIZE    (16384*3)
#define LAF_TX_BUFFER_INIT_SIZE    (16384*3)
...
unsigned int laf_tx_req_len = LAF_TX_BUFFER_INIT_SIZE;
		...
		size_t count, loff_t *pos)
{
	...
	if (unlikely(count > laf_rx_req_len))
		return -EINVAL;
