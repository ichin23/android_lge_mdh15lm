...
////[200508] ADS Change
////[START]=====================================================//
////static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x00, 0x0C, 0x00, 0x0C, 0x00, 0x0C, 0x33, 0x13, 0x13, 0x13, 0x07, 0x70, 0x64, 0x64, 0x64, 0x64, 0x64, 0x64, 0x50, 0x85, 0x20, 0x04, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x9E, 0x01, 0x99, 0x01, 0x07 };
//static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x00, 0x0C, 0x00, 0x0C, 0x00, 0x0C, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x64, 0x64, 0x64, 0x64, 0x64, 0x64, 0x50, 0x85, 0x20, 0x04, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x9E, 0x01, 0x99, 0x01, 0x07 };
////[END]=======================================================//
#if defined(CONFIG_MACH_MT6762_EH15LM) || defined(CONFIG_MACH_MT6765_EH35LM)
#define CNT_INITCODE					42
#else
#define CNT_INITCODE					41
#endif

#if defined(CONFIG_MACH_MT6762_EH15LM)
...
static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x11, 0x9A, 0x00, 0x21, 0x00, 0x19, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x74, 0x82, 0x64, 0x82, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x18, 0x33, 0x19, 0x31, 0xFC, 0x4F, 0x0A, 0x3D, 0x04, 0x06, 0x04 };
#elif defined(CONFIG_MACH_MT6765_EH35LM)
static const unsigned char InitCodeAddr[CNT_INITCODE] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x11, 0x9A, 0x00, 0x21, 0x00, 0x15, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x74, 0x82, 0x64, 0x82, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x19, 0x0D, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x1A, 0x3F, 0x13, 0x30, 0xFC, 0x4F, 0x0B, 0x33, 0x03, 0x06, 0x04 };
#else
static const unsigned char InitCodeAddr[CNT_INITCODE] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x00, 0x29, 0x00, 0x29, 0x00, 0x29, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0x82, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0xFE, 0x03, 0x33, 0x01, 0x07, 0x04 };
#endif
//[END]=======================================================//
