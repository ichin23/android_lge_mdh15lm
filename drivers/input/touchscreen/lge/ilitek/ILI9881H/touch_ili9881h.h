...
#define ILI9881H_SLAVE_I2C_ADDR		0x41
#define ILI9881H_ICE_MODE_ADDR		0x181062
#define ILI9881H_PID_ADDR		0x4009C
#define ILI9881H_WDT_ADDR		0x5100C
#define ILI9881H_PC_ADDR		0x44008
#define ILI9881H_LATCH_ADDR		0x51010
#define ILI9881H_IC_RESET_ADDR		0x040050
#define ILI9881H_IC_RESET_KEY		0x00019881
#define ILI9881H_IC_RESET_GESTURE_ADDR	0x040054
#define ILI9881H_IC_RESET_GESTURE_KEY	0xF38A94EF
#define ILI9881H_IC_RESET_GESTURE_RUN	0xA67C9DFE
...
extern void ili9881h_get_pc_latch(struct device *dev);
extern int ili9881h_dump_flash_data(struct device *dev, u32 start, u32 end);
extern void ili9881h_dump_iram_data(struct device *dev, u32 start, u32 end);
...
extern int ili9881h_check_int_status(struct device *dev, bool high);
extern int ili7807_get_fw_data_wrapper(struct device *dev, u8 *wdata, int wsize, void *rdata, int rsize);
extern void ili9881h_get_ddi_reg_onepage(u8 page, u8 reg, u8 *data);
