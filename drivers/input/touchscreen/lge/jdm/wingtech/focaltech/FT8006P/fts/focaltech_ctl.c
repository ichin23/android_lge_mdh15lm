...
extern int ft8006m_reg_read(struct device *dev, u16 addr, void *data, int size);
extern int ft8006m_reg_write(struct device *dev, u16 addr, void *data, int size);
