...
#define FF_COMPATIBLE_NODE_1 "mediatek,mt6765-fingerprint"
...
static const char *g_pinctrl_state_names[FF_PINCTRL_STATE_MAXIMUM] = {
	"fingerprint_rst_low", "fingerprint_rst_high", "fingerprint_irq"
};
...
int ff_ctl_init_pins(int *irq_num)
{
	...
	/* Get regulator */
	g_context->ff_vdd = regulator_get(NULL, "irtx_ldo");
