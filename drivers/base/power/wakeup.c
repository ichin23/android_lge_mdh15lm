...
#ifdef CONFIG_LGE_PM
static struct dentry *wakeup_sources_active_stats_dentry;

/**
 * print_wakeup_source_active_stats - Print active wakeup source statistics information.
 * @m: seq_file to print the statistics into.
 * @ws: Wakeup source object to print the statistics for.
 */
					    ...
					    struct wakeup_source *ws)
{
	...
	/* do not print if invalid active time */
...
/**
 * wakeup_sources_active_stats_show - Print active wakeup sources statistics information.
 * @m: seq_file to print the statistics into.
 */
...
#ifdef CONFIG_LGE_PM
	wakeup_sources_active_stats_dentry =
			debugfs_create_file("wakeup_sources_active",
			S_IRUGO, NULL, NULL,
			&wakeup_sources_active_stats_fops);
#endif
	return 0;
}
