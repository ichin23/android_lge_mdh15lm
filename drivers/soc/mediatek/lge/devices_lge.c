...
char *rev_str[] = {
	...
	"rev_0_1",
	"rev_a",
#if defined(CONFIG_MACH_MT6765_DH40LM) || defined(CONFIG_MACH_MT6762_DH15LM)
	"rev_a_1",
#endif
	"rev_b",
	"rev_c",
#if defined(CONFIG_MACH_MT6762_MH55LM) || defined (CONFIG_MACH_MT6762_MH45LM) || defined(CONFIG_MACH_MT6762_DH15LM)
	"rev_d",
#endif
	"rev_10",
	"rev_11",
