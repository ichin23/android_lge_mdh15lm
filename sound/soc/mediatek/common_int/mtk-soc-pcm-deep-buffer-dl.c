...
extern int ak4376_hw_params_dl1(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params);
#endif

#ifdef CONFIG_SND_SOC_ES9218P
extern int es9218_pcm_hw_params_dl1(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params);
#endif
...
#endif
	ak4376_hw_params_dl1(substream, hw_params);
#endif
#ifdef CONFIG_SND_SOC_ES9218P
#if defined(CONFIG_LGE_HIFI_HWINFO)
	if (lge_get_hifi_hwinfo())
#endif
	es9218_pcm_hw_params_dl1(substream, hw_params);
#endif
