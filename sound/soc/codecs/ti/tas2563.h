...
#define TAS2563_InterruptMaskReg1_Disable 0xff
  ...
  /* Interrupt Mask Reg2 */
#define TAS2563_InterruptMaskReg2  TAS2563_REG(0x0, 0x0, 0x1c)
#define TAS2563_InterruptMaskReg2_VBATUVLOINTMASK_Mask  (0x1 << 5)
#define TAS2563_InterruptMaskReg2_VBATUVLOINTMASK_Unmask  (0x0 << 5)
#define TAS2563_InterruptMaskReg2_VBATUVLOINTMASK_Disable  (0x1 << 5)
#define TAS2563_InterruptMaskReg2_Disable 0xff
...
#define TAS2563_LatchedInterruptReg1_BrownOutShutdownSticky_Mask  (0x1 << 2)
#define TAS2563_LatchedInterruptReg1_BrownOutShutdownSticky_NoInterrupt  (0x0 << 2)
#define TAS2563_LatchedInterruptReg1_BrownOutShutdownSticky_Interrupt  (0x1 << 2)
...
#define TAS2563_LatchedInterruptReg2  TAS2563_REG(0x0, 0x0, 0x26)
#define TAS2563_LatchedInterruptReg2_VBATUVLOSticky_Mask  (0x1 << 5)
#define TAS2563_LatchedInterruptReg2_VBATUVLOSticky_NoInterrupt  (0x0 << 5)
#define TAS2563_LatchedInterruptReg2_VBATUVLOSticky_Interrupt  (0x1 << 5)
...
#define ERROR_TDM_CLOCK	    0x0000008
#define ERROR_UNDER_VOLTAGE	0x0000010
#define ERROR_BROWNOUT_SHUTDOWN	0x0000020
